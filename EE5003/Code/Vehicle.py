...
import random
import ray
from ray.worker import UTIL_WORKER_MODE
...
class vehicle_model(object):
    ...
    def __init__(self, num = 0, type = "Vs", com_source = random.uniform(3,7), weight1 = 0.5, weight2 = 0.5):
        self.num = num
        self.type = type
        self.com_source = com_source
...
# test code
vehicle_1 = vehicle_model.remote(1)
vehicle_2 = vehicle_model.remote(2)
